...
# Using Appward PAT:
#ASANA_API_TOKEN = "2/1208690861600158/1210647336210715:bf2c65e178b3d8d3f5b5c3a28cd70159"

# Using Vivant PAT:
ASANA_API_TOKEN = "2/733168370816659/1210841931621836:a5d3430a16a66b669ffb0efd30e7914d"
            ...
            if action == "added" and resource_type == "story" and resource_subtype == "comment_added":
                ...
                if comment_details:
                    ...
                    if comment_text.strip().lower().startswith("@1e"):
                        ...
                        """
                        cur.execute(sql_insert_inbox, (project_gid, task_gid, task_name, comment_gid, comment_text, created_at, created_by, 'asana', 'V1E'))
                        conn.commit()
